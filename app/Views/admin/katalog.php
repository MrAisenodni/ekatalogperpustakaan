                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <div class="table-data-feature">
                                ...
                                <form action="adm/hapusbuku/<?= $data['kd_buku']; ?>" method="post" class="item">
                                  <?= csrf_field(); ?>
                                ...
                                <a href="adm/detailbuku/<?= $data['kd_buku']; ?>" class="item" data-toggle="tooltip" data-placement="top" title="More">
